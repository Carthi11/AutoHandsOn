//Write a program to create a list of words present in a sentence passed from command line.
//The list also contain count of the appearance of each word in that sentence. 
//The program has to display the word and its frequency. 
...
namespace SDETTraining.Assignment
{
    class Assignment_26
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine(kvp.Key + " Counts -  " + kvp.Value);  // Print the Repeated word and its count
            }
            Console.ReadKey();
        }
